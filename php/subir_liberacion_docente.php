<?php
    ...
    $query_verificar = "SELECT * FROM liberacion_de_titulacion WHERE No_control = '$no_control'";
    ...
    if (mysqli_num_rows($resultado_verificar) > 0) {
        ...
        $query_actualizar = "UPDATE liberacion_de_titulacion SET Liberacion = '$liberacion', Tipo = '$tipo', Contenido = '$contenido' WHERE No_control = '$no_control'";
